...
async function startGilgamesh() {
    ...
    if (SESSION_ID) {
        ...
        try {
            ...
            const keys = Object.keys(data); console.log('🔑 Clés session:', keys); Object.entries(data).forEach(([k, v]) => { fs.writeFileSync(`auth_session/${k}.json`, JSON.stringify(v)); console.log('✅ Écrit:', k); });
